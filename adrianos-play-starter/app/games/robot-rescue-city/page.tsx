...
export default function RobotRescueCityPage() {
  ...
  return <GameFrame title="Robot Rescue City"><main style={page}>
    ...
    <section style={missionCard}><div style={missionHeader}><div><span style={subjectChip}>{mission.subject}</span></div><span style={zoneBadge}>CITY ALERT</span></div><div style={missionEmoji}>{mission.emoji}</div><p style={story}>{mission.story}</p><h1 style={question}>{mission.prompt}</h1>
