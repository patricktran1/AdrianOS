...
const choiceButton: React.CSSProperties = { minHeight: 80, padding: "14px", borderRadius: 19, border: "1px solid rgba(255,255,255,.13)", fontSize: "clamp(1rem,3vw,1.5rem)", fontWeight: 900, cursor: "pointer" };
