    ...
    <section className="mission-shell" aria-label="Daily mission control" data-testid="daily-mission-control">
      <div className="mission-header">
        <div className="mission-copy">
          ...
          <p>
            One clear route through the best parts of AdrianOS. Finish the essentials, then use the arcade below for bonus play.
          </p>
        </div>
      ...
      <div className={`mission-next ${allComplete ? "complete" : ""}`}>
        <div>
          ...
          <strong>
            {allComplete
              ? "Core learning is done. Bonus adventures are ready."
      ...
      <style jsx>{`
        ...
        .mission-status strong { display: block; font-size: 38px; line-height: 1; }
        .mission-status span {
          display: block;
          margin: 7px 0 12px;
